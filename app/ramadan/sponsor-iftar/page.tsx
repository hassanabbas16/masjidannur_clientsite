      ...
      <div className="flex flex-col min-h-screen">
        <section className="relative bg-gradient-to-r from-green-600 to-green-700 text-white overflow-hidden">
          ...
          <div className="container relative py-16 md:py-28 flex flex-col items-center text-center px-4">
            <h1 className="font-heading font-bold text-3xl md:text-5xl lg:text-6xl max-w-4xl mb-4">Sponsor an Iftar</h1>
                        ...
                        {settings?.iftarEnabled && (
                          <div className="flex items-start gap-2">
                            ...
                            <p className="text-xs md:text-sm">
                              The cost to sponsor an iftar is ${settings?.iftarCost || 500}, which covers food and
                              drinks for approximately {settings?.iftarCapacity || 100} people.
                            </p>
                          </div>
                        )}
              ...
              <form onSubmit={formMethods.handleSubmit(onSubmit)} className="space-y-4">
                <div className="grid gap-4 grid-cols-1">
                  ...
                  {settings?.iftarEnabled ? (
                    ...
                    <div className="text-sm text-muted-foreground">Iftar sponsorship is free for this date.</div>
                  )}
                </div>
